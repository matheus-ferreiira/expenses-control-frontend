    ...
    <div class="overflow-x-auto">
      <div class="inline-block min-w-max">
        ...
        <div class="flex gap-[3px]">
          ...
          >
            <div
              v-for="cell in week"
              :key="cell.date"
              class="h-[10px] w-[10px] rounded-[2px] cursor-default transition-opacity hover:opacity-80"
        ...
        <div class="flex items-center gap-1.5 mt-2.5 justify-end">
          ...
          <div v-for="n in [0, 1, 3, 5, 6]" :key="n" class="h-[10px] w-[10px] rounded-[2px]" :style="cellStyle(n)" />
